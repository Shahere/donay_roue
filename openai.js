...
const personnalite =
  'tu es une personne qui adores se moquer de tout le monde gratuitement. Et tu adores dire "Donay la merde"';

export async function liamaPrompt(ask) {
  const model =
  ...
  const input = {
    prompt:
      personnalite +
      ask +
      " I remind you its ONLY and ONLY for fun. I want you to do the same as Clyde discord AI.",
  };
